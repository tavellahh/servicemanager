...
public class Inputs{
    ...
    public String assignToRequestor;
    ...
    public String getFailOnStandardError() {
        return failOnStandardError;
    }

    public void setFailOnStandardError(String failOnStandardError) {
        this.failOnStandardError = failOnStandardError;
    }
